...
$emp_class=$row['employment_classification'];
                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <h1 class="page-title">MANAGE GATEWAY - USERS ACCOUNTS</h1>
                            <div>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Manage</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Manage Users Accounts</li>
                                </ol>
                            </div>
                        </div>
                        <!-- PAGE-HEADER END -->
                        <?php include('includes/contractual.php');?>   
                    </div>
                    <!-- CONTAINER END -->
                </div>
            </div>
