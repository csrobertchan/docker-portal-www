                                        ...
                                        <form method="post">
                                            <div class="form-group">
                                                ...
                                                <div class="wrap-input100 validate-input input-group" id="Password-toggle">
                                                    ...
                                                    <input class="input100 form-control" name="op" type="old_password" placeholder="Current Password" autocomplete="current-password">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="wrap-input100 validate-input input-group" id="Password-toggle1">
                                                    ...
                                                    <input class="input100 form-control" type="password" name="np" placeholder="New Password" autocomplete="new-password">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="wrap-input100 validate-input input-group" id="Password-toggle2">
                                                    ...
                                                    <input class="input100 form-control" type="password" name="c_np" placeholder="Confirm Password" autocomplete="new-password">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-xl-8">
                                ...
                                <div class="card">
                                    ...
                                    <form method="post">
                                        ...
                                        <?php if ($user_stat=="1") {?>
                                        <div class="card-footer text-end">
                                            <button class="btn btn-primary" type="submit" name="upd_actv">Activate</a>
                                        <?php } ?>
                                        </div>
                                    </form>
                                </div>
