...
if(isset($_REQUEST['id'])){
    ...
    $sql="select * from opis WHERE emp_id=$id";
...
<body style="height: 100wh;" onload="window.print()" id="main">
...
<tbody>
  ...
  <tr>
    <td class="tg-0lax"><?php echo $row["month1"]; ?><div style="float: right;" align="right"><b><?php echo number_format($row["1st_cutoff"], 2, '.', ','); ?></div></b></td>
    <td class="tg-0lax" colspan="2"><?php echo $row["month2"]; ?><div style="float: right;" align="right"><b><?php echo number_format($row["2nd_cutoff"], 2, '.', ','); ?></div></b></td><?php ?>
  </tr>
</tbody>
</table>
</div>
